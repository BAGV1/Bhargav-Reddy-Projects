...
img_a = load_image("image_b.jpg")
img_b = load_image("image_a.jpg")

# Flatten into a flat list 4096, 3 to compare colors
...
# Reshapes the list into 64x64 grid
result = matched_pixels.reshape(64, 64, 3).astype(np.uint8)

output = PILImage.fromarray(result)
output.save("phase2_result.jpg")
print("Saved to phase2_result.jpg")
